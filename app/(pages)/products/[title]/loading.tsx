...
const loading = () => {
   return (
      <div className="container-px flex  flex-col gap-3 pb-[16px] pt-[80px] md:pt-[110px] lg:flex-row">
         <div className="animate-pulse lg:w-2/4">
         ...
         <div className="lg:w-2/4">
            <div className="box-p bg-secondary container-rounded flex h-[100px] w-full animate-pulse lg:h-[200px]" />
            <div className="bg-secondary container-rounded mt-[12px] flex h-[100px] w-full animate-pulse lg:h-[200px]" />
            <div className="bg-secondary container-rounded mt-[12px] flex h-[100px] w-full animate-pulse lg:h-[200px]" />
         </div>
      </div>
   )
