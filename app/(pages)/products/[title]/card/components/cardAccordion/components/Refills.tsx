...
const Refills = ({ refills }: { refills: string }) => {
   const sanitizedHtmlDifferent = sanitize(refills)

   const [refillsTrigger, setRefillsTrigger] = useState(false)
   ...
   return (
      <div className="h-full w-full ">
         <div
            onClick={() => {
               setRefillsTrigger((previous) => !previous)
